        ...
        <div className="space-y-6">
            ...
            >
                <div className="space-y-4">
                    ...
                    <p className="text-gray-600">
                        Puedes consultar el documento oficial de cortes de admisión para el proceso 2025 en el siguiente enlace:
                    </p>

                    <a
                        href={data.pdfOficial || "https://ori.ucr.ac.cr/sites/default/files/archivos/2025/_Cortes25.pdf"}
                        target="_blank"
                    ...
                    >
                        ...
                        Abrir PDF de Cortes Oficiales 2025
                    </a>
                </div>
            </Modal>
        </div>
